...
public class CasRellesAudit {
    ...
    public CasRellesAudit(String type, String objectId, String discriminator, String transactionHash, String diffs, String blameId, String blameUser, String blameUserFqdn, String blameUserFirewall, String ip, LocalDateTime createdAt) {
        this.type = type;
    ...
    public CasRellesAudit(int id, String type, String objectId, String discriminator, String transactionHash, String diffs, String blameId, String blameUser, String blameUserFqdn, String blameUserFirewall, String ip, LocalDateTime createdAt) {
        this.id = id;
        this.type = type;
        this.objectId = objectId;
        this.discriminator = discriminator;
    ...
    public String toString() {
        return "CasRellesAudit{" + "id=" + this.id + ", type='" + this.type + '\'' + ", objectId='" + this.objectId + '\'' + '}';
    }
}
